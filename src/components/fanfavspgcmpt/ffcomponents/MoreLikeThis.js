...
import MoreLikeThisCard from '../../cards/MoreLikeThisCard';
  ...
  return (
    ...
    <div>
        <div className='toppicks'>
            ...
            <h3 style={{color:"black"}}>More like this</h3>
    ...
    <Slide {...settings} slidesToScroll={4} slidesToShow={4} style={{height:"100vh",backgroundColor:"white"}}>
        {
            moviess && moviess.map((card,index)=>(
                      <div classname="divstyle" style={{ ...divStyle }}>
                        <MoreLikeThisCard id={card.id} image={card.image} title={card.title} rating={card.rating}/>
                      </div>
                      )
                      )
                  }
