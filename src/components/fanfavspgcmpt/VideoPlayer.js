    ...
    <div className='video'>
      <div className='vpsmallhead'>
        ...
        <div className='vpcolumn2'>
            ...
            <p style={{paddingLeft:"1%"}}>All topics</p>
            <div className='ffvl'></div>
      ...
      <div className="videoplayer">
        <div className='wldetails' >
                ...
                <button style={{position:"absolute",marginTop:"-0.5%",marginLeft:"-0.5%"}}
          onClick={()=>{
            dispatch(
...
        />
      ...
      <div className='btns' >
      <button className='tnbtn'>Action</button>
      <button className='tnbtn'>Adventure</button>
      <button className='tnbtn'>Drama</button>
      </div>
