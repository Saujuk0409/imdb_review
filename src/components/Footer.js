    ...
    <div>
      ...
      <RecentlyViewed/>
            ...
            <div className="imdblinks">
                ...
                <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" class="ipc-icon ipc-icon--launch-inline ipc-icon--inline ipc-link__launch-icon" id="iconContext-launch-inline" viewBox="0 0 24 24" fill="white" role="presentation" style={{paddingLeft:"5%"}}>
