    ...
    <div className="watchcarousl">
      ...
      <div className="topicks-div">
        ...
        <div className="sub-head">
          <p
            style={{paddingTop: "1%", textAlign: "left",fontSize: "2.1rem",color: "grey",fontWeight: "400" }}>This week's top TV and movies</p>
        </div>
      </div>
    </div>
    <div
      className="scroller"
      style={{ width: "70%", marginLeft: "10%", marginTop: "1%" }}
    >
      <Slide
        {...settings}
        slidesToScroll={6}
      ...
      >
        {movies &&
          movies.map((card, index) => (
            // <div style={{color:"white"}}>kkskshdsdh</div>
            <WatchCard
              id={card.id}
              image={card.poster}
              title={card.title}
